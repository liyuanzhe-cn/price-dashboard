...
CACHE_SCHEMA_VERSION = 9  # v18换MVRV/MVRV-Z/Realized Price数据源+新增200日均线,数据结构变了
...
WATCHLIST = {
    ...
    "SMST": "SMST",  # Defiance Daily Target 2X Short MSTR ETF(MSTR反向杠杆)
    "MSTX": "MSTX",  # Defiance Daily Target 2X Long MSTR ETF(MSTR正向杠杆)
