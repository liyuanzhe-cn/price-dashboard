...
# 每个ticker之间随机等待1-3秒；仍保留连续失败熔断，遇到限流会自动冷却10分钟。
PER_TICKER_DELAY_RANGE = (1, 3)
...
CHINESE_NAMES = {
    "AAPL":"苹果", "MSFT":"微软", "GOOG":"谷歌", "GOOGL":"谷歌", "AMZN":"亚马逊",
    "META":"Meta平台", "NVDA":"英伟达", "TSLA":"特斯拉", "BRK.B":"伯克希尔·哈撒韦",
